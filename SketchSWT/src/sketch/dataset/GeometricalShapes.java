...
public class GeometricalShapes extends DataSet {
	
	private int numberSketchers = 5;
	
	private int numberGesturesByClass = 10;
	
	public GeometricalShapes(Composite parent, int style) throws SketchException {
		super(parent, style);
		
		for(Control control: parent.getChildren())
			if(control instanceof GeometricalShapes && control != this)
	...
	public dataset.DataSet dataSet() {
		return dataset.DataSet.getGeometricalShapes(numberSketchers, numberGesturesByClass);
	}
